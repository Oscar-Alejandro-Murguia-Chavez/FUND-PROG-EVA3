...
public class PROYECTO {
    ...
    public static void main(String[] args) {            
        ...
        do{
            ...
            System.out.println("1> Calculadora hexadecimal");
            System.out.println("2> Calculadora binaria");
            System.out.println("3> Calculadora octal");
            System.out.println("4> Sistema de conversion de unidades");
    ...
    public static void calculadoraMatrices(){
        ...
        String[][] matrizV = new String[3][3];
        for (int i = 0; i < matrizV.length; i++) {
            for (int j = 0; j < matrizV[i].length; j++) {
                matrizV[i][j] = "  *";
            }
        }
    ...
    public static String[][] llenarMatrizVisual(){
        String[][] lleno = new String [3][3];
    ...
    public static void convertirFAC(){
        ...
        System.out.println("Introduce el numero");
        num = input.nextDouble();
        resultado = num * -17.22222222222222;
    ...
    public static void convertirFAK(){
        ...
        System.out.println("Introduce el numero");
        num = input.nextDouble();
        resultado = num * 255.92777777777775;
